...
if (isset($_POST['Submit'])) {
	...
	foreach($_POST as $key => $details){
		$query = "UPDATE EmailTemplates SET Details = '".$details."', UpdatedBy = '".@$_SESSION['id']."' WHERE ID = '".$key."'";
        ...
        <div id="main">
            ...
            <div class="page-content">
                <section class="row">
					...
					$sql = "SELECT distinct ID, Title, Details FROM EmailTemplates ";
					...
					while($headings = mysqli_fetch_array($result)) {
							...
							?>
									...
									<div class="card-body">
                                        ...
                                        <label for="DisabilityDetails" class="form-label"><?php echo $headings['Title']; ?></label>
