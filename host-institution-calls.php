                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header alert alert-primary alert-dismissible fade show">
									<ul>
										<li>Filtered list of Calls that have been registered on the system.</li>
										<li>You can increase number of entries to display on a page by click "Show Entries" dropdown</li>
										<li>Search for Calls by typing on the search box</li>
										<li>Click "Add New Call" button to add a new entry</li>
